...
namespace Tree
{
    ...
    */
    ...
    public class BoggleRadix
    {
        ...
        public BoggleRadix(string[] dictionary)
        {
            tree = new RadixTree();
            Build(dictionary);
        }
        ...
        private void SearchWord(int i, int j, StringBuilder str)
        {
            ...
            var node = tree.FindPartial(str.ToString());
            if (node == null)
            {
            ...
            if (node.IsTerminal == true && str.Length == node.Label.Length)
            {
