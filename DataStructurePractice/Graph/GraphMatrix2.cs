...
namespace Graph
{
        ...
        where V: struct
    {
        ...
        private IEdge2<V, E>[,] adjacencyMatrix;
        ...
        public GraphMatrix2(int count)
        {
            ...
            vertexID = 0;
            adjacencyMatrix = new IEdge2<V, E>[count, count];
        }
