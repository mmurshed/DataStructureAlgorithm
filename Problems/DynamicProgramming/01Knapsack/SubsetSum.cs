...
namespace Algorithm.DynamicProgramming
{
    public class SubsetSum
    {
         ...
         * 
         * If any of the above the above subproblems return true, then 
         * return true.
         * 
         ...
         * The problem is in-fact NP-Complete (There is no known polynomial 
         ...
         * bottom up manner. The value of subset[i][j] will be true if there is
         * a subset of set[0..j-1] with sum equal to i., otherwise false.
